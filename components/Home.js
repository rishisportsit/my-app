      ...
      <div className="bannermain_wrapper">
        <div className="banner_wrapper">
          <div className={`design_wrapper ${isRight ? "hidden" : "visible"}`}>
            ...
            <span className="span_tag" >Product designer specialising in UI design an Design systems.</span>
          </div>
          <Image
          ...
          <div className={`coder_wrapper ${isRight ? "visible" : "hidden"}`}>
            ...
            <span className="span_tag" >Front end developer who writes clean, elegant and efficient code.</span>
          </div>
        </div>
      </div>
