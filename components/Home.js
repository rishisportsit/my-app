...
function Home() {
  ...
  const launchGame = async (project) => {
    ...
    setGameLoading(true);
    try {
      const response = await fetch(process.env.NEXT_PUBLIC_GAME_API_URL, {
        method: "POST",
    ...
    >
        ...
        <div className="banner_wrapper">
          ...
          >
            <Image
              ...
              style={{
                transform:
                  windowWidth > 1650 ? `translateX(${offsetX}px)` : "none",
      ...
      <div className="work_section">
        ...
        >
            ...
            {projectData
              ...
              .map((project) => (
                <motion.div
                  ...
                  style={{
                    flex:
                      project.layout === "mobile" ? "1 1 350px" : "1.8 1 600px",
                    minHeight: "600px",
                    display: "flex",
          ...
          >
            {projectData
              .filter((p) => !p.category || p.category !== "betting")
              .slice(0, 3)
              .map((project) => (
                <motion.div
                  key={project.id}
                  whileHover={{
                    y: -6,
                    boxShadow: "0 20px 48px -6px rgba(0, 0, 0, 0.12)",
                  }}
                  className="portfolio__project"
                  style={{
                    background: "#0a0a0a",
          ...
          {selectedProject && (
            ...
            >
              ...
              >
                ...
                >
                  <div
                    className="portfolio__modal-img-wrap"
                ...
                <div className="portfolio__modal-right">
                  ...
                  <div className="portfolio__modal-header">
                    <span className="portfolio__modal-label">
                      {selectedProject.category === "betting"
                        ? "Platform"
                        : "Game"}
                    </span>
